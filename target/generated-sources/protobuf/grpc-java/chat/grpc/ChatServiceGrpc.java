...
@javax.annotation.Generated(
    ...
    comments = "Source: chat_stream_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ChatServiceGrpc {

  private ChatServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "chat.grpc.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<chat.grpc.ChatMessage,
      chat.grpc.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = chat.grpc.ChatMessage.class,
      responseType = chat.grpc.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<chat.grpc.ChatMessage,
      chat.grpc.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<chat.grpc.ChatMessage, chat.grpc.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<chat.grpc.ChatMessage, chat.grpc.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chat.grpc.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<chat.grpc.ChatMessage> chat(
        io.grpc.stub.StreamObserver<chat.grpc.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<chat.grpc.ChatMessage> chat(
        io.grpc.stub.StreamObserver<chat.grpc.ChatMessage> responseObserver) {
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return chat.grpc.ChatServiceProto.getDescriptor();
    }
